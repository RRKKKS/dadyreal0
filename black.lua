...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'😁❤️تم حظره من الصانع').Reply,"md",true)  
end 
...
if text == "بوت" then
    ...
    send(msg.chat_id,msg.id,"عايز اي؟")
    return false 
    end

    if text == "فينوم" then

        send(msg.chat_id,msg.id,"خخ اي')
        return false 
        end
...
send(msg.chat_id,msg.id,"• مرحبا عزيزي في مصنع الحماية  لسورس فينوم \n• مبرمج السورس @r_n_b1","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
----
if text == 'المطور' or text == 'مبرمج السورس' or text == 'الباشا' then  
local UserId_Info = LuaTele.searchPublicChat("𝐃𝐀𝐃𝐘 𝐕𝐄𝐍𝐎𝐌")
...
local TestText = "𝐃𝐀𝐃𝐘 𝐕𝐄𝐍𝐎𝐌\n— — — — — — — — —\n 🇪🇬*َdev name•* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n🇪🇬*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝐃𝐀𝐃𝐘 𝐕𝐄𝐍𝐎𝐌', url = "https://https://t.me/RB_RO"}
},
}
...
{
{text = '𝐃𝐀𝐃𝐘 𝐕𝐄𝐍𝐎𝐌', url = "https://https://t.me/RB_RO1"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = 'ِّّ𝐃𝐀𝐃𝐘 𝐕𝐄𝐍𝐎𝐌, url = 'https://t.me/RB_RO1'}, 
},
}
